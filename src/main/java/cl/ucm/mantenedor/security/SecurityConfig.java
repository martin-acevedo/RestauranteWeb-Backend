    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT,"/auth/update-pass/**").hasAnyRole("ADMIN", "GESTOR", "CAJERO")
                        .requestMatchers("/dept/all").hasAnyRole("GESTOR","ADMIN")
                        .requestMatchers("/dept/save").hasAnyRole("GESTOR","ADMIN")
                        .requestMatchers(HttpMethod.GET, "/sales/corte/**").hasAnyRole("GESTOR","CAJERO","ADMIN")
