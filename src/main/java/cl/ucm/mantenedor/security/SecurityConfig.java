    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/pedido/**").hasAnyRole("Mesero", "Administrador")
                        .requestMatchers(HttpMethod.POST, "/pedido/**").hasAnyRole("Mesero", "Administrador")
                        .requestMatchers(HttpMethod.PUT, "/pedido/**").hasAnyRole("Mesero", "Administrador")
                        .anyRequest()
                        .authenticated()
                )
